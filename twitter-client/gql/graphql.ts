...
export type GetCurrectLoginQueryQuery = { __typename?: 'Query', getCurrectUser?: { __typename?: 'User', id: string, firstName: string, lastName?: string | null, email: string, profileImageUrl?: string | null } | null };
